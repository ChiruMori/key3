    ...
    <li class="nav-item">
        ...
        <div id="collapseClub" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="py-2 collapse-inner rounded">
                ...
                <a class="collapse-item token-tag" href="/key3/admin/page/club-announce"><i class="fas fa-bell mr-2"></i>公告管理</a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="py-2 collapse-inner rounded">
                ...
                <a class="collapse-item token-tag" href="/key3/admin/page/club-relation"><i class="fas fa-link mr-2"></i>社团关系</a>
            </div>
        </div>
    </li>
